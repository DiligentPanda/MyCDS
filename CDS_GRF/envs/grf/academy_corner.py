...
class Academy_Corner(MultiAgentEnv):
    ...
    def __init__(
        ...
        time_step=0,
        obs_dim=217,
        env_name='benchmark_academy_corner',
        stacked=False,
        ...
        module = importlib.import_module("envs.grf.scenarios.{}".format('benchmark_academy_corner'))
        sys.modules["gfootball.scenarios.{}".format("benchmark_academy_corner")] = module
